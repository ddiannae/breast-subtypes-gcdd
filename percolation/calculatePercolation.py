...
def getPercolationGraph(path, sample_size):
    ...
    for cond in conds.keys():
        ...
        while True:
            ...
            sortedEdges = sortedEdges[nToRemove:]
            #print("removedEdges: ", str(len(edgesToRemove)), " remainingEdges", str(len(sortedEdges)))
            cSizes = getComponentSizes(graph)
            if cSizes:
...
def main(args):
    ...
    # getPercolationGraph("/mnt/ddisk/transpipeline-data/breast-data/subtypes/networks/aracne-cluster/1/100k/", 1000)
